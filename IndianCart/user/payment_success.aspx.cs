    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (order == Session["order_no"].ToString())
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "insert into orders values ('" + dr["firstname"].ToString() + "', '" + dr["lastname"].ToString() + "','" + dr["email"].ToString() + "','" + dr["address"].ToString() + "', '" + dr["city"].ToString() + "'+ '" + dr["state"].ToString() + "', '" + dr["pincode"].ToString() + "','" + dr["mobile"].ToString() + "')";
                cmd.ExecuteNonQuery();
